...
SELECT d02 AS num FROM xt_0 WHERE d01 = 'yw_16';
SELECT d02 FROM xt_0 WHERE d01 = 'yw16_fb';

SELECT * FROM bd_5 WHERE lid IN ('408641483202101249','408641483202101250');
SELECT * FROM bd_5 WHERE lid IN ('408641483202101249');

--
SHOW CREATE TABLE yw_10b;
CREATE TABLE `yw_10b` (
  `oid` INT(11) NOT NULL AUTO_INCREMENT,
  `lid` VARCHAR(20) DEFAULT '',
  `y01` VARCHAR(20) DEFAULT '',
  ...
  `y03` VARCHAR(20) DEFAULT '',
  `y04` VARCHAR(20) DEFAULT '',
  `y05` CHAR(1) DEFAULT '0',
  `y06` VARCHAR(20) DEFAULT '',
  `y07` VARCHAR(20) DEFAULT '',
  `y08` VARCHAR(20) DEFAULT '',
  `y09` VARCHAR(20) DEFAULT '',
  `y10` VARCHAR(20) DEFAULT '',
  `y11` VARCHAR(20) DEFAULT '',
  `y12` VARCHAR(20) DEFAULT '',
  `y13` VARCHAR(20) DEFAULT '',
  `y14` VARCHAR(20) DEFAULT '',
  `y15` CHAR(2) DEFAULT '',
  `y16` VARCHAR(20) DEFAULT '',
  `y17` VARCHAR(20) DEFAULT '',
  `y18` CHAR(2) DEFAULT '',
  `y19` VARCHAR(20) DEFAULT '',
  `y20` VARCHAR(20) DEFAULT '',
  `y21` VARCHAR(20) DEFAULT '',
  `y22` CHAR(2) DEFAULT '',
  `y23` VARCHAR(20) DEFAULT '',
  `y24` VARCHAR(20) DEFAULT '',
  `y25` VARCHAR(20) DEFAULT '',
  `y26` TEXT,
  `g01` CHAR(2) DEFAULT '1',
  `g02` VARCHAR(20) DEFAULT '',
  `g03` VARCHAR(50) DEFAULT '',
...
UPDATE yw_10b SET y05 = '1' g05 = '396667372305383424' g06 = '屠焕炯' g07 = '2018-06-09 15:09:14' WHERE lid = '2732144767158272';


SELECT a.lid,a.y02,a.y11,b.y34,c.y03
FROM yw_10 a
LEFT JOIN yw_4 b ON a.lid = b.lid
LEFT JOIN yw_138a c ON a.lid = c.y01
WHERE a.g01 = '1' AND c.g01 = '1' AND c.g04 LIKE '2018-06%';

SELECT a.lid,a.y02,a.y11,b.y34 FROM yw_10 a LEFT JOIN yw_4 b ON a.lid = b.lid WHERE a.g01 = '1';
--  require yw_138a:y01,g01,g04
-- find:y03
SELECT * FROM yw_138a WHERE g04 LIKE '2018-07%';
...
LEFT JOIN yw_138a c ON a.lid = c.y01 
WHERE  a.g01 = '1' AND c.g01 = '1' AND c.g04 LIKE '2018-06%';
SELECT y01 AS project,COALESCE(SUM(y03),0) AS receipt FROM yw_138a WHERE g01 = '1' AND g04 LIKE '2018-06%' AND y01 IN ('402414776291950592','402417819301445632','402417819301445633','402417819301445634') GROUP BY y01;

-- payment table:yw_26

-- 06.11
-- String findSQL = "SELECT y01 AS lid,COALESCE(SUM(y03),0) AS receipt FROM yw_138a WHERE g01 = '1' AND y01 IN (" + placeholder + ") GROUP BY y01";
SELECT y06 AS lid,COALESCE(SUM(y08),0) AS payment FROM yw_26 WHERE g01 = '1' AND y06 IN ('402417819301445632','410388326021857280','445868792598233088') GROUP BY y06;
SELECT SUM(y08) FROM yw_26 GROUP BY lid;
SELECT * FROM yw_10;
SELECT lid AS id,y02 AS TEXT FROM yw_10

SELECT y01 AS lid,COALESCE(SUM(y03),0) AS receipt FROM yw_138a WHERE g01 = '1' AND g04 LIKE '2018-07%' AND y01 IN ('402414776291950592') GROUP BY y01;
SELECT * FROM yw_138a WHERE g01 = '1' AND g04 LIKE '2018-07%' AND y01 IN ('402414776291950592') GROUP BY y01;
SELECT TO_DAYS(NOW());
SELECT NOW();
SELECT DATE_FORMAT(NOW(),'%Y-%m');
SELECT DATE_FORMAT(NOW(),'%y-%m');
-- select name,submittime from enterprise where date_format(submittime,'%Y-%m')=date_format(now(),'%Y-%m')
SELECT * FROM yw_26 WHERE DATE_FORMAT(g04,'%Y-%m') = DATE_FORMAT(NOW(),'%Y-%m');
SELECT * FROM yw_26 WHERE DATE_FORMAT(g04,'%Y-%m') = '2018-06';
SELECT * FROM yw_26 WHERE DATE_FORMAT(g04,'%y-%m') = '2018-06';
SELECT * FROM yw_138a WHERE DATE_FORMAT(g04,'%y-%m') <= '2018-08';
SELECT * FROM yw_26 WHERE DATE_FORMAT(g04,'%Y-%m') = DATE_FORMAT(NOW(),'%Y-%m');
SELECT * FROM yw_26 WHERE DATE_FORMAT(g04,'%Y-%m') = DATE_FORMAT(DATE_SUB(CURDATE(),INTERVAL 1 MONTH),'%Y-%m');
...
--
SELECT y01 AS lid,COALESCE(SUM(y03),0) AS receipt FROM yw_138a WHERE g01 = '1' AND DATE_FORMAT(g04,'%Y-%m') = '2018-06' AND y01 IN ('402417819301445632') GROUP BY y01;
SELECT y06 AS lid,COALESCE(SUM(y08),0) AS beforepayment FROM yw_26 WHERE g01 = '1' AND DATE_FORMAT(g04,'%Y-%m') = '2018-06' AND y06 IN ('445868792598233088') GROUP BY y06;
-- 1
SELECT y01 AS lid,COALESCE(SUM(y03),0) AS beforereceipt FROM yw_138a WHERE g01 = '1' AND DATE_FORMAT(g04,'%Y-%m') <= '2018-06' AND y01 IN ('445868792598233088') GROUP BY y01;
-- 2
SELECT y06 AS lid,COALESCE(SUM(y08),0) AS beforepayment FROM yw_26 WHERE g01 = '1' AND DATE_FORMAT(g04,'%Y-%m') <= '2018-06' AND y06 IN ('445868792598233088') GROUP BY y06;
SELECT * FROM yw_26 WHERE g01 = '1' AND y06 = '445868792598233088';

SELECT COUNT(*) FROM yw_10b WHERE g01 = 1 AND y13 = '453245603124609024';
SELECT COUNT(*) FROM yw_10b WHERE g01 = 1 AND y13 = '453245603124609024' AND y05 = '1';
SELECT y02,y05 FROM yw_10b WHERE g01 = 1 AND y13 = '453245603124609024' AND y05 = '1';

SELECT y02,y05 AS total FROM yw_10b WHERE g01 = 1 AND y13 = '2732144779118592' AND y05 = '1';

SHOW VARIABLES LIKE '%max_allowed_packet%'; 

SELECT * FROM xt_0 WHERE d01 = 'yw_16';

-- projectLID:453245603124609024

SELECT * FROM yw_15a WHERE y04='泰山石膏板' AND y02 IN('2018061100000231');

SELECT lid AS id,y02 AS TEXT FROM yw_10 WHERE g01 = '1' ORDER BY oid DESC;